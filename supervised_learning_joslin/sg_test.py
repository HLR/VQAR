...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', default="/VL/space/zhan1624/VQAR-launcher/VQAR_all/VQAR/data/model_ckpts_sg_test1/")
    ...
    parser.add_argument('--test_f', default="/VL/space/zhan1624/VQAR-launcher/VQAR_all/VQAR/src/supervised_learning_joslin/joslin/rescources/new_label_data/train.pickle")
