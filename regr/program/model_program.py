...
from .model.pytorch import PoiModel, PoiModelToWorkWithLearnerWithLoss, SolverModel, SolverModelDictLoss, SolverListPOIModel, ListPoiModel
...
class ListPOIProgram(LearningBasedProgram):
    def __init__(self, graph, **kwargs):
        super().__init__(graph, ListPoiModel, **kwargs)
