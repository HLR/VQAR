...
class ClauseNTrainer():
    ...
    def __init__(self,
        ...
        with open("/VL/space/zhan1624/VQAR-launcher/VQAR_all/VQAR/src/supervised_learning_joslin/joslin/rescources/hossein_data/concepts1.json") as f_in:
            self.hierechy_labels = json.load(f_in)
    ...
    def _batch_pass(self, batched_dp, update_axiom=True, is_train=True):
        ...
        batched_tps, batched_probs, batched_torch_probs = get_batched_fact_probs(self.sg_model, batched_dp, self.idx2word, self.dl_inter, self.hierechy_labels, self.reinforce)
