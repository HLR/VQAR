...
from regr.program import SolverPOIProgram, SolverListPOIProgram
...
def model_declaration():
    ...
    program = SolverListPOIProgram(graph, loss=MacroAverageTracker(NBCrossEntropyLoss()), metric=PRF1Tracker(DatanodeCMMetric()))
